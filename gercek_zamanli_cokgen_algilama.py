...
while 1:
    ...
    lh=cv2.getTrackbarPos("Lower-Hue","Settings")#renk tonu
    ls = cv2.getTrackbarPos("Lower-Saturation", "Settings")#doyma
    ...
    if cv2.waitKey(1) & 0xFF == ord("q"):#her bir frame 1 milisaniye gösterilecek ve diğerine geçilecek
        break
